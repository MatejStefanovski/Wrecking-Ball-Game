...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField, Range(0f, 1f)] private float endSfxVolume = 0.9f;
    ...
    private void Start()
    {
        ...
        blocksRemaining = FindObjectsByType<Block>(FindObjectsSortMode.None).Length;
    ...
    private void Update()
    {
        ...
        if (ballController != null && ballController.transform.position.y < outOfBoundsY)
        {
            EndGame(false);
        }
    }
